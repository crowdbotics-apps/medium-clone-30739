  ...
  render = () => (
    ...
    >
      ...
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/77b0/725b/ac5dbfba869b7fa97e796e437ad6ccad"
        }}
        style={styles.ImageBackground_201_100}
      />
      <View style={styles.View_201_101}>
        <Text style={styles.Text_201_101}>
          After you’re finished with a saved story, tap the archive icon to
          store it here.
        </Text>
      </View>
      <TouchableOpacity
        style={styles.TouchableOpacity_201_165}
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("35_421"))
        }
      >
        <View style={styles.View_I201_165_61_0}>
          <Text style={styles.Text_I201_165_61_0}>Stories worth saving</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_201_111}>
        <TouchableOpacity
          style={styles.TouchableOpacity_I201_111_37_15}
          onPress={() =>
            this.props.navigation.navigate(getNavigationScreen("33_278"))
          }
        >
          <View style={styles.View_I201_111_27_195}>
            <Text style={styles.Text_I201_111_27_195}>Saved(14)</Text>
          </View>
        </TouchableOpacity>
        <View style={styles.View_I201_111_37_52}>
          <View style={styles.View_I201_111_27_196}>
            <Text style={styles.Text_I201_111_27_196}>Archived</Text>
          </View>
          <View style={styles.View_I201_111_37_95} />
        </View>
        <TouchableOpacity
          style={styles.TouchableOpacity_I201_111_37_102}
          onPress={() =>
            this.props.navigation.navigate(getNavigationScreen("35_681"))
          }
        >
          <View style={styles.View_I201_111_27_197}>
            <Text style={styles.Text_I201_111_27_197}>Recently viewed</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.TouchableOpacity_I201_111_37_164}
          onPress={() =>
            this.props.navigation.navigate(getNavigationScreen("201_67"))
          }
        >
          <View style={styles.View_I201_111_27_198}>
            <Text style={styles.Text_I201_111_27_198}>Highlighted</Text>
          </View>
        </TouchableOpacity>
      </View>
      <View style={styles.View_201_112}>
        <View style={styles.View_I201_112_23_27}>
          <Text style={styles.Text_I201_112_23_27}>Reading list</Text>
        </View>
        <View style={styles.View_I201_112_23_26} />
      </View>
      <View style={styles.View_201_113}>
        <View style={styles.View_I201_113_14_15}>
          <View style={styles.View_I201_113_14_16}>
            <Text style={styles.Text_I201_113_14_16}>9:41 AM</Text>
          </View>
          <View style={styles.View_I201_113_14_17}>
            <View style={styles.View_I201_113_14_18}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/52a1/3408/3b0c0296ccd84a1d138bb3ee6bdb6dbe"
                }}
                style={styles.ImageBackground_I201_113_14_19}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_I201_113_14_22}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_I201_113_14_23}
              />
            </View>
            <View style={styles.View_I201_113_14_24}>
              <Text style={styles.Text_I201_113_14_24}>100%</Text>
            </View>
            <View style={styles.View_I201_113_14_25}>
              <View style={styles.View_I201_113_14_26}>
                <ImageBackground
                  source={{
                    uri:
                      "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2191/dc02/5fd629bb6d0db5ab555204d411e66355"
                  }}
                  style={styles.ImageBackground_I201_113_14_27}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_I201_113_14_30}
                />
                <ImageBackground
                  source={{
                    uri:
                  ...
                  style={styles.ImageBackground_I201_113_14_31}
                />
              </View>
            </View>
            <View style={styles.View_I201_113_14_32}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a8c3/25af/3e57917fb09697ef0f78fbad1e341c20"
                }}
                style={styles.ImageBackground_I201_113_14_33}
              />
            </View>
          </View>
          <View style={styles.View_I201_113_14_37}>
            <View style={styles.View_I201_113_14_38}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/acc4/b3f5/7dc3d29066d931adb161e357c5267bc6"
                }}
                style={styles.ImageBackground_I201_113_14_39}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_I201_113_14_40}
              />
            </View>
            <View style={styles.View_I201_113_14_44}>
              <Text style={styles.Text_I201_113_14_44}>Figma</Text>
            </View>
            <View style={styles.View_I201_113_14_45}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/bd86/8c8e/a03cb81d4e35311d64fc72f488169d1a"
                }}
                style={styles.ImageBackground_I201_113_14_46}
              />
            </View>
          </View>
        </View>
      </View>
      <View style={styles.View_201_167}>
        <View style={styles.View_I201_167_15_22} />
        <TouchableOpacity
          style={styles.TouchableOpacity_I201_167_38_0}
          onPress={() =>
        ...
        >
          <TouchableOpacity
            ...
            style={styles.TouchableOpacity_I201_167_16_13}
            onPress={() =>
              this.props.navigation.navigate(getNavigationScreen("1_2"))
            }
          />
          <View style={styles.View_I201_167_16_9}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6b28/4349/32ea338d7b57c03e68fdd780c3c7a6f9"
              }}
              style={styles.ImageBackground_I201_167_16_9_11_26}
            />
          </View>
          <TouchableOpacity
            style={styles.TouchableOpacity_I201_167_16_28}
            onPress={() =>
          ...
          >
            <ImageBackground
              ...
              style={styles.ImageBackground_I201_167_16_28_11_66}
            />
          </TouchableOpacity>
          <TouchableOpacity
            source={{
...
const styles = StyleSheet.create({
  ...
  ImageBackground_201_100: {
    width: wp("100%"),
    minWidth: wp("100%"),
    height: hp("27.05866228872868%"),
    minHeight: hp("27.05866228872868%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("0%"),
    top: hp("30.434782608695656%")
  },
  View_201_101: {
  ...
  TouchableOpacity_201_165: {
    width: wp("45.33333333333333%"),
    minWidth: wp("45.33333333333333%"),
    height: hp("7.04647676161919%"),
    minHeight: hp("7.04647676161919%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("27.46666666666667%"),
    top: hp("82.3088455772114%"),
  ...
  TouchableOpacity_I201_111_37_15: {
    flexGrow: 1,
  ...
  TouchableOpacity_I201_111_37_102: {
    flexGrow: 1,
  ...
  TouchableOpacity_I201_111_37_164: {
    flexGrow: 1,
    width: wp("20%"),
    height: hp("6.446776611694154%"),
    marginLeft: 0,
  ...
  ImageBackground_I201_113_14_19: {
    width: wp("6.4%"),
    minWidth: wp("6.4%"),
    height: hp("1.7241379310344827%"),
  ...
  ImageBackground_I201_113_14_22: {
    width: wp("0.4%"),
    minWidth: wp("0.4%"),
  ...
  ImageBackground_I201_113_14_23: {
  ...
  ImageBackground_I201_113_14_27: {
  ...
  ImageBackground_I201_113_14_30: {
  ...
  ImageBackground_I201_113_14_31: {
  ...
  ImageBackground_I201_113_14_33: {
  ...
  ImageBackground_I201_113_14_39: {
    width: wp("0.8%"),
  ...
  ImageBackground_I201_113_14_40: {
    width: wp("3.2%"),
  ...
  ImageBackground_I201_113_14_46: {
    width: wp("3.8%"),
    height: hp("1.4992503748125936%"),
    top: hp("0.2998500749625187%"),
    marginLeft: 0,
  ...
  TouchableOpacity_I201_167_38_0: {
    flexGrow: 1,
    width: wp("88.8%"),
  ...
  TouchableOpacity_I201_167_16_13: {
  ...
  ImageBackground_I201_167_16_9_11_26: {
    flexGrow: 1,
  ...
  TouchableOpacity_I201_167_16_28: {
    width: wp("7.733333333333333%"),
    minWidth: wp("7.733333333333333%"),
    height: hp("4.3478260869565215%"),
    minHeight: hp("4.3478260869565215%"),
  ...
  ImageBackground_I201_167_16_28_11_66: {
    flexGrow: 1,
  ...
  TouchableOpacity_I201_167_16_0: {
    width: wp("7.733333333333333%"),
    height: hp("4.3478260869565215%"),
    top: hp("0%"),
    marginLeft: 0,
  ...
  ImageBackground_I201_167_15_27_11_34: {
    flexGrow: 1,
